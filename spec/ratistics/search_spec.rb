  ...
  describe Search do
    ...
    context '#linear_search' do
      ...
      context 'with ActiveRecord', :ar => true do
        ...
        specify do
          ...
          index = Search.linear_search(sample, 10){|r| r.place}
          index.should eq 9
        end
      ...
      context 'Hamster', :hamster => true do
        ...
        specify { Search.linear_search(list, 11).should eq 5 }

        specify { Search.linear_search(vector, 11).should eq 5 }
      end
    end
    ...
    context '#binary_search' do
      ...
      context 'with ActiveRecord', :ar => true do
        ...
        specify do
          sample = Racer.where('place > 0').order('place asc')
          index = Search.binary_search(sample, 10){|r| r.place}
          index.should eq [9, 9]
        end
      ...
      context 'Hamster', :hamster => true do
        ...
        specify { Search.binary_search(list, 11).should eq [5, 5] }

        specify { Search.binary_search(vector, 11).should eq [5, 5] }
      end
    end
